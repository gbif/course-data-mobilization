...
[cols="10%,90%"]
|===
a|image::img/icons/loading.png[computer loading icon, width=100px,height=100px]
<.^|Software activity: install software required for activities later in the course
|===
...
++++
<div class="involveme_embed" data-embed="gbif/dm-sec-1-150d" data-width="640" data-min-height="480"></div>
...
++++
<iframe src="https://www.classmarker.com/online-test/start/?quiz=gk4602d48fa23ead&iframe=1" frameborder="0" style="width:100%;max-width:700px;" height="800"></iframe>
++++
