...
image:img/icons/video-player.png[video player icon, width=100px,height=100px,align="left", valign="middle"] Watch three videos on the definitions, software and structures for this course.
