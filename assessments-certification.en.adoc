...
[cols=2*]
|===
a|image::img/logos/GBIF-biodiversity-data-mobilization.png[align="center", width="150", height="150"]
|An overall score of 2.5-2.9 earns a BASIC Biodiversity Data Mobilization badge

a|image::img/logos/GBIF-biodiversity-data-mobilization-ADVANCED.png[align="center", width="150", height="150"]
